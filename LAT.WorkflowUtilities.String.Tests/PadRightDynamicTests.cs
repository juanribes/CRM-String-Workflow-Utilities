...
namespace LAT.WorkflowUtilities.String.Tests
{
    ...
    public class PadRightDynamicTests
    {
        ...
        public PadRightDynamicTests()
        {
            ...
            _namespaceClassAssembly = "LAT.WorkflowUtilities.String.PadRightDynamic" + ", " + "LAT.WorkflowUtilities.String";
        }
        #endregion
        ...
        public void Single0()
        {
            ...
            //Test
            Assert.AreEqual(expected, output["PaddedString"]);
        }
