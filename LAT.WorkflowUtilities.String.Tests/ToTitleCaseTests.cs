...
namespace LAT.WorkflowUtilities.String.Tests
{
    ...
    public class ToTitleCaseTests
    {
        ...
        public ToTitleCaseTests()
        {
            ...
            _namespaceClassAssembly = "LAT.WorkflowUtilities.String.ToTitleCase" + ", " + "LAT.WorkflowUtilities.String";
        }
        #endregion
        ...
        public void StringLower()
        {
            ...
            //Test
            Assert.AreEqual(expected, output["TitleCasedString"]);
        }
