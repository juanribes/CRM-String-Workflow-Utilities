...
namespace LAT.WorkflowUtilities.String.Tests
{
    ...
    public class CreateEmptySpacesTests
    {
        ...
        public CreateEmptySpacesTests()
        {
            ...
            _namespaceClassAssembly = "LAT.WorkflowUtilities.String.CreateEmptySpaces" + ", " + "LAT.WorkflowUtilities.String";
        }
        #endregion
        ...
        public void ZeroSpaces()
        {
            ...
            //Test
            Assert.AreEqual(expected, output["EmptyString"]);
        }
